...
with Pool(os.cpu_count() - 2) as p:
    results = list(tqdm.tqdm(p.imap(getPhoto, dat), total=len(dat)))
# for i, d in enumerate(dat):
#     # print("Downloading: {:.1f}% Complete".format((i/total)*100), end="\r")
#     if getPhoto(d):
#         downloaded += 1
#     else:
#         skipped += 1
...
skipped = len(dat) - downloaded
print(str(downloaded), "images downloaded")
print(str(skipped), "skipped, already downloaded or could not find")
